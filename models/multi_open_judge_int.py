...
def main():
    ...
    ap.add_argument("--model_columns", nargs="+",
                    default=["AF3_summary","Qwen_summary","Kimi_summary","Salmon_summary","GAMA_summary"])
    ap.add_argument("--reference_column", default="Llama_summary")
    ap.add_argument("--output_dir", default="results/Interview/MultiJudge")
